<div class="card">
    ...
    <div class="card-body p-3" >
        <div>
            <span style="color: #B59377;">Servicios:</span>
        ...
        <div class="form-group mt-5">
            <button class="btn btn-sm btn-block" style="background-color: #B59377;color:white" {{ $totalCart> 0 ? '' :'disabled'}}>Agendar</button>
        </div>
        <div class="form-group mt-5">
            <button onclick="openPayment()" class="btn btn-sm btn-block" style="background-color: #B59377;color:white" {{ $totalCart> 0 ? '' :'disabled'}}>Cerrar Cita</button>
        </div>
        <div class="form-group mt-5">
            <button wire:click="borrarCita(1)" class="btn btn-dark btn-sm btn-block ">Cancelar</button>
        </div>
    </div>
</div>